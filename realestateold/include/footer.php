            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="footer-item">
                    ...
                    <ul class="contact-info">
                        <li>
                            Address: Shop# 01, Plot 14-C, Street No 12, Phase V ext. Badar Commercial DHA Karachi.
                        </li>
                        <li>
                            Email: <a href="mailto:info@themevessel.com">arbabassociates1@gmail.com</a>
                        </li>
                        <li>
                            Phone: <a href="tel:+0477-85x6-552">+92300-2218149</a>
                        </li>
                    </ul>
