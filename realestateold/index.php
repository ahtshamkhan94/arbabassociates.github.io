...
<h3 data-animation="animated fadeInUp delay-05s">ARBAB ASSOCIATES</h3>



                            <h2 data-animation="animated fadeInDown delay-5s">Real Estate Advisor & Consultant</h2>
                            <p class="text-p" data-animation="animated fadeInUp delay-5s">
                            </p>
                             <a data-animation="animated fadeInUp delay-5s" href="properties.php" class="btn btn-lg btn-round btn-theme">Get Started Now</a>
...
<h3 data-animation="animated fadeInUp delay-05s">ARBAB ASSOCIATES</h3>
                            ...
                            <h2 data-animation="animated fadeInDown delay-5s">Find Your Dream Properties</h2>
                            <p class="text-p" data-animation="animated fadeInUp delay-5s">
                            </p>
                            <a data-animation="animated fadeInUp delay-5s" href="properties.php" class="btn btn-lg btn-round btn-theme">Get Started Now</a>
                        </div>
                ...
                <div class="carousel-caption banner-slider-inner d-flex h-100 text-left">
                    <div class="carousel-content container">
                        <div class="t-left">
                             ...
                             <h3 data-animation="animated fadeInUp delay-05s">ARBAB ASSOCIATES</h2>
                            <h3 data-animation="animated fadeInUp delay-05s">Best Place For Sell Properties</h2>
                            <p class="text-p" data-animation="animated fadeInUp delay-5s">
                            </p>
...
<div class="testimonial-2 overview-bgi" style="background-image: url(assets/img/testimonial-property.jpg) ;    height :300px">
                        ...
                        <div class="heading">
                            ...
                            <div class="location">
                                <a href="properties-details.html">
                                    <i class="flaticon-facebook-placeholder-for-locate-places-on-maps"></i> M-25/2 Khyaban-e-saadi Phase VII DHA Karachi
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="carousel-item active">
                                <div class="row">
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                        <div class="avatar">
                                          <  <img src="assets/img/avatar/avatar.jpg" alt="avatar-2" class="img-fluid rounded">
                                        </div>
                                    </div>
                                    <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                        <p class="lead">
Speciallist in Banglow Sale / Rent                                        </p>
                            ...
                            <div class="carousel-item">
                             ...
                             <!--           <div class="avatar">
                                    ...
                                    <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                        <p class="lead">
Speciallist in Plots Sale / Rent                                        </p>
                                        <div class="author-name">
                                            Martin Smith
                                        </div>
                                        <ul class="rating">
                            ...
                            <div class="carousel-item">
                                <div class="row">
                                    ...
                                    <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                        <p class="lead">
Speciallist in Apartment Sale / Rent                                       </p>
                                        <div class="author-name">
                                            John Antony
                                        </div>
                                        <ul class="rating">
